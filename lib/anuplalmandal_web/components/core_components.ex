defmodule AnuplalmandalWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AnuplalmandalWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AnuplalmandalWeb.Gettext, "errors", msg, opts)
    end
  end
